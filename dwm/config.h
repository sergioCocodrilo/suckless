...
*/
// the following two lines are for the iMac, for the laptop is too big
//static const char *fonts[]          = { "FiraCode Nerd Font Mono:size=20" };
//static const char dmenufont[]       = "FiraCode Nerd Font Mono:size=20";
